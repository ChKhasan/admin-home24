        ...
        <div class="d-flex justify-content-between align-items-center card_header">
          <div class="prodduct-list-header-grid w-100 align-items-center">
            <SearchInput
              ...
              @changeSearch="
                ($event) =>
                  changeSearch($event, '/orders/returned-orders', '__GET_ORDERS')
              "
            />
            <div class="input status-select w-100"></div>
            <span></span>
            <a-button
              @click="clearQuery('/orders/returned-orders', '__GET_ORDERS')"
              type="primary"
...
this.__GET_REGIONS();
  ...
  methods: {
    ...
    watch: {
      async current(val) {
        this.changePagination(val, "/orders/returned-orders", "__GET_ORDERS");
      },
    },
  },
